...
const warn = funcName =>
    'Be aware! String.prototype.{0} already exists. Fox-FoxInflector lib will not replace it, so str.{0}() won\'t work as expected!'.replace(/\{0\}/g, funcName);

// First, checks if it isn't implemented yet.
if (!String.prototype.pluralize)
    String.prototype.pluralize = function() {
        return FoxInflector.pluralize(''+ this);
    };
else
...
if (!String.prototype.singularize)
    String.prototype.singularize = function() {
        return FoxInflector.singularize(''+ this);
    };
else
...
if (!String.prototype.titleize)
    String.prototype.titleize = function(ucAll = false) {
        return FoxInflector.titleize(''+ this, ucAll);
    };
else
...
if (!String.prototype.camelize)
    String.prototype.camelize = function() {
        return FoxInflector.camelize(''+ this);
    };
else
...
if (!String.prototype.camel2words)
    String.prototype.camel2words = function(ucwords = true) {
        return FoxInflector.camel2words(''+ this, ucwords);
    };
else
...
if (!String.prototype.camel2id)
    String.prototype.camel2id = function(separator = '-') {
        return FoxInflector.camel2id(''+ this, separator);
    };
else
...
if (!String.prototype.id2camel)
    String.prototype.id2camel = function(separator = '-') {
        return FoxInflector.id2camel(''+ this, separator);
    };
else
...
if (!String.prototype.underscore)
    String.prototype.underscore = function() {
        return FoxInflector.underscore(''+ this);
    };
else
...
if (!String.prototype.humanize)
    String.prototype.humanize = function(ucAll = false) {
        return FoxInflector.humanize(''+ this, ucAll);
    };
else
...
if (!String.prototype.variablize)
    String.prototype.variablize = function() {
        return FoxInflector.variablize(''+ this);
    };
else
...
if (!String.prototype.tableize)
    String.prototype.tableize = function() {
        return FoxInflector.tableize(''+ this);
    };
else
...
if (!String.prototype.slug)
    String.prototype.slug = function(replacement = '-', lowercase = true) {
        return FoxInflector.slug(''+ this, replacement, lowercase);
    };
else
...
if (!String.prototype.classify)
    String.prototype.classify = function() {
        return FoxInflector.classify(''+ this);
    };
else
...
if (!String.prototype.ordinalize)
    String.prototype.ordinalize = function() {
        return FoxInflector.ordinalize(''+ this);
    };
else
    console.warn(warn('ordinalize'));

module.exports = Object.freeze(FoxInflector);
